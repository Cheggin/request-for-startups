#!/usr/bin/env node
/**
 * Auto-finish Stop hook — runtime-agnostic.
...
const WRITE_TOOL_NAMES = new Set(['Edit', 'Write', 'MultiEdit', 'file_edit', 'file_write']);
...
const IGNORED_STATUS_PATHS = new Set(['.claude/command-log.txt', '.harness/command-log.txt']);
...
const SCOPE_PREFIXES = [
  ...
  { prefix: '.agents/skills/', scope: 'skills' },
